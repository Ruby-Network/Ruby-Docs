...
Assuming you are running a Linux system based off of Ubuntu, run the following command to install some prerequisites:

Note if you are running a different distro of Linux you can find the instructions [here](https://docs.docker.com/engine/install/)
